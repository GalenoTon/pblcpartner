...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen text-slate-900 overflow-x-hidden">
      ...
      <section className="py-24 bg-white relative overflow-hidden px-6 md:px-12 lg:px-16 xl:px-24">
  <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(21,164,229,0.1),transparent_70%)]"></div>
  <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(21,164,229,0.1),transparent_70%)]"></div>

  <div className="container mx-auto relative">
    <div className="text-center max-w-3xl mx-auto mb-20 fade-in-section opacity-0 transition-all duration-1000">
      <div className="inline-flex items-center px-6 py-2 bg-[#E6F7FF] border border-[#15A4E5]/30 rounded-full mb-8 hover:bg-[#15A4E5]/10 hover:border-[#15A4E5]/50 transition-all duration-500 ease-out">
        <span className="text-sm font-medium text-[#15A4E5] tracking-wider uppercase">Nossos Pilares</span>
      </div>
      <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">
        <span>Áreas de </span>
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#15A4E5] to-[#4BC0F0] hover:bg-gradient-to-l transition-all duration-700 ease-in-out">
          Atuação
        </span>
      </h2>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      {[
        ...
        >
          <Card
            className={`h-full fade-in-section opacity-0 transition-all duration-700 ease-out hover:shadow-2xl hover:shadow-[#15A4E5]/20
            group-hover:-translate-y-2 group-hover:border-[#15A4E5]/40 transform-gpu 
            relative overflow-hidden border-2 border-transparent hover:border-[#15A4E5]/30`}
          >
            ...
            <CardContent className="p-6 h-full flex flex-col relative z-10">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-white/20 backdrop-blur-sm rounded-2xl mb-6 
                group-hover:bg-white/30 group-hover:scale-110 transition-all duration-600 ease-out shadow-lg group-hover:shadow-xl group-hover:shadow-[#15A4E5]/30 border border-white/20">
        ...
        <div className="container mx-auto relative">
          <div className="max-w-3xl mx-auto text-center fade-in-section opacity-0 transition-all duration-1000">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="group bg-gradient-to-r from-[#15A4E5] to-[#4BC0F0] hover:from-[#0E8BC0] hover:to-[#3AA0D0] text-white px-10 py-6 text-lg font-semibold shadow-xl hover:shadow-[#15A4E5]/30 transition-all duration-300 hover:scale-[1.03]"
                asChild
              >
                <Link href="/contato">
              ...
              <Button
                variant="outline"
                size="lg"
                className="group border-2 border-[#15A4E5]/40 text-[#15A4E5] hover:bg-[#15A4E5]/5 px-10 py-6 text-lg font-semibold bg-white/80 backdrop-blur-sm hover:scale-[1.02]"
                asChild
              >
                <Link href="/contato">
