            ...
            <div className="fade-in-section opacity-0 transition-all duration-1000 delay-300 order-1 lg:order-2">
              <div className="bg-gradient-to-br from-[#E6F7FF] to-[#D1F0FF] border border-[#49B5EA]/20 rounded-2xl p-2 sm:p-8 md:p-10 shadow-lg">
                ...
                <div className="mt-8 sm:mt-12">
                  <h3 className="font-bold text-lg sm:text-xl text-slate-800 mb-3 sm:mb-4">Rede social</h3>
                  <div className="flex space-x-3 sm:space-x-4">
                    {[
                      // {
                      //   icon: "M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z",
                      //   href: "#" // Facebook - atualize com link real
                      // },
                      {
                      ...
                      <a
                        ...
                        className="bg-white p-2 sm:p-3 rounded-lg shadow-sm border border-slate-200 hover:bg-[#49B5EA]/10 transition-colors flex items-center space-x-2"
                      >
                        <svg className="h-4 w-4 sm:h-5 sm:w-5 text-[#49B5EA]" fill="currentColor" viewBox="0 0 24 24">
                          <path d={social.icon} />
                        </svg>
                        {social.name && (
                          <span className="text-sm font-medium text-[#49B5EA]">{social.name}</span>
                        )}
                      </a>
                    ))}
                  </div>
